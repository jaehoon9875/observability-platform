 ...
 *   1. NotificationNotFoundException      → 404 Not Found
...
public class GlobalExceptionHandler {
    ...
    /**
     * 알림을 찾을 수 없을 때 404 응답을 반환한다.
     *
     * @param e 발생한 NotificationNotFoundException
     * @return RFC 7807 형식의 404 ProblemDetail
     */
    @ExceptionHandler(NotificationNotFoundException.class)
    public ProblemDetail handleNotificationNotFound(NotificationNotFoundException e) {
